...
public class CombineBitmapActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_combine_bitmap);
    ...
    private void loadWechatBitmap(ImageView imageView, int count) {
        CombineBitmap.init(CombineBitmapActivity.this)
