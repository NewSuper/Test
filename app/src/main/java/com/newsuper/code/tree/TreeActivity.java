package com.newsuper.code.tree;
...
public class TreeActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lazyOrgConfig.setLineColor(Color.BLACK).setTextSize(12).setLineWidth(4).setTextBgRes(R.drawable.shape_corner);
        ...
        lazyOrgView.setOnItemClickListener(new TreeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, TreeNode node) {
                Toast.makeText(TreeActivity.this, "这个是第" + position + "个 Item, 包含空Item,\n节点内容为: " + node.getNodeEntity(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}