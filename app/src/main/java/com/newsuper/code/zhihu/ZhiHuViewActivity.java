package com.newsuper.code.zhihu;
...
public class ZhiHuViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhihu_view);
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view;
            if (viewType == 1) {
                view = View.inflate(ZhiHuViewActivity.this, R.layout.item1, null);
            } else {
                view = View.inflate(ZhiHuViewActivity.this, R.layout.item0, null);
        ...
        public void onBindViewHolder(MyHolder holder, int position) {
            if (position == 9) {
                ...
                holder.windowImageView.setImageResource(R.mipmap.ic_launcher);
            } else if (position == 19) {
                holder.windowImageView.bindRecyclerView(rv_content);
//                holder.windowImageView.setFrescoEnable(false);
